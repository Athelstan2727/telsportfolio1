        ...
        <div class="space-y-40">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center reveal">
                ...
                <div class="h-[400px] w-full relative z-20"> 
                    <div class="absolute inset-0 w-full h-full rounded-3xl overflow-hidden border border-white/10 shadow-2xl">
                        <img src="{{ asset('images/ecoflow1.jpg') }}" class="w-full h-full object-cover" alt="Greenhouse Setup">
                    </div>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center reveal">
                <div class="order-2 lg:order-1 h-[400px] w-full relative z-20"> 
                    <div class="absolute inset-0 w-full h-full rounded-3xl overflow-hidden border border-white/10 shadow-2xl">
                        <img src="{{ asset('images/ecoflow2.jpg') }}" class="w-full h-full object-cover" alt="Machine Learning Diagnostics">
                    </div>
                </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center reveal">
                ...
                <div class="h-[400px] w-full relative z-20"> 
                    <div class="absolute inset-0 w-full h-full rounded-3xl overflow-hidden border border-white/10 shadow-2xl">
                        <img src="{{ asset('images/ecoflow3.jpg') }}" class="w-full h-full object-cover" alt="ESP32 Hardware">
                    </div>
                </div>
            </div>
